...
public class dialog_container_add extends AppCompatDialogFragment {
    ...
    @SuppressLint("ValidFragment")
    public dialog_container_add(Context context, DialogResultEventListener event){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.dialog_container_add,container,false);
