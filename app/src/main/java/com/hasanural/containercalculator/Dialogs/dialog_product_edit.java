...
public class dialog_product_edit extends AppCompatDialogFragment {
    ...
    @SuppressLint("ValidFragment")
    public dialog_product_edit(Context context, DialogResultEventListener event){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.dialog_product_edit,container,false);
        Product pro= SingletonOrderModel.getInstance().productModel;
        b_cancel=v.findViewById(R.id.dialog_product_button_cancel);
        b_edit=v.findViewById(R.id.dialog_product_button_edit);
        b_delete=v.findViewById(R.id.dialog_product_button_delete);
